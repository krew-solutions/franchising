...
Предметом торга выступают не знания сами по себе в изоляции, как кот в мешке, внешне ничем не отличимые от заблуждений, а конкретное улучшение внутреннего качества ПО и повышение темпов разработки.
...
Уровень дохода подрядчика не всегда коррелирует с реальным уровнем её квалификации (Джордж Акерлоф описал эту проблему в классической статье «Рынок лимонов»).
    ...
    Предположим далее, что владелец каждого «лимона» готов продать его за 1000 долларов, тогда как каждый потенциальный покупатель готов заплатить за «лимон» 1500 долларов.
...
Причем, наилучшего результа достигают системы, купирующие `Эффект Даннинга-Крюгера <https://ru.m.wikipedia.org/wiki/%D0%AD%D1%84%D1%84%D0%B5%D0%BA%D1%82_%D0%94%D0%B0%D0%BD%D0%BD%D0%B8%D0%BD%D0%B3%D0%B0_%E2%80%94_%D0%9A%D1%80%D1%8E%D0%B3%D0%B5%D1%80%D0%B0>`__, путем ограничения влияния участников с недостаточным уровнем в отношении участников с превосходящим уровнем.
...
Я начал разработку Open Source проекта `grade <https://github.com/emacsway/grade>`__, призванного решить эту проблему.
